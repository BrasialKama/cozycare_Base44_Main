        ...
        <div className="px-5 pb-5">
          ...
          <div className="mt-3.5 flex flex-wrap gap-2">
            ...
            {nanny.specialties?.slice(0, 2).map((s) => (
              <Badge key={s} variant="secondary" className="text-[11px] font-medium bg-sage/25 text-sage-foreground border-0 rounded-lg">
                {s}
              </Badge>
            ))}
