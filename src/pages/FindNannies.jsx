      ...
      <div className="flex gap-2.5">
        <div className="flex-1 relative">
          ...
          <Input
            ...
            className="pl-11 h-12 rounded-xl bg-card border-border/60 text-sm focus-visible:ring-primary/30"
          />
          {search && (
            ...
            <div className="space-y-8 mt-6 px-1">
              <div>
                <Label className="text-sm font-semibold mb-4 block text-foreground">
                  Max Hourly Rate
                  <span className="ml-2 font-normal text-primary">${maxRate[0]}/hr</span>
                </Label>
                <Slider value={maxRate} onValueChange={setMaxRate} min={10} max={100} step={5} className="mt-2" />
              ...
              <div>
                <Label className="text-sm font-semibold mb-4 block text-foreground">
                  Min Experience
                  <span className="ml-2 font-normal text-primary">{minExperience[0]} yrs</span>
                </Label>
                <Slider value={minExperience} onValueChange={setMinExperience} min={0} max={20} step={1} className="mt-2" />
                <div className="flex justify-between text-xs text-muted-foreground mt-2">
              ...
              <div className="pt-4 flex gap-2">
                <Button
                  variant="outline"
                  className="flex-1"
                  onClick={() => { setMaxRate([80]); setMinExperience([0]); setActiveSpecialty(''); }}
                >
                  Reset
                </Button>
